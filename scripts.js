document.addEventListener("DOMContentLoaded", () => {
    ...
    const lawEventsData = [
        ...
        { title: "The Plot Twist", fee: "₹499", prize: "₹18,000", type: "Storytelling", desc: "Create engaging stories with unexpected twists.(A participant can be part of only one team.)" },
        ...
        { title: "Shabd Sangram (Debate)", fee: "₹499", prize: "₹18,000", type: "Debate", desc: "Compete in a verbal battle of arguments." },
    ...
    const techEventsData = [
        ...
        { title: "Escape the Bug-Tech Maze", fee: "₹399", prize: "₹12000", type: "Tech / Puzzle", desc: "Solve coding and tech-based challenges to progress through levels." },
    ...
    const socialScienceEventsData = [
        ...
        { title: "Canvas Carnival 2.0", fee: "₹399", prize: "₹12,000", type: "Art Competition", desc: "Create a painting on the spot based on a surprise theme and present your idea." }
    ];
    ...
    const events = {
        tech: [
            ...
            { name: "Script Writing Competition", price: 299 }, { name: "Escape the Bug-Tech Maze", price: 399 },
        ...
        socialScience: [
            ...
            { name: "Canvas Carnival 2.0", price: 399 }
        ],
        architecture: [
